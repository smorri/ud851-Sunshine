...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Creates a menu element in the ActionBar
     *
     * @param menu
     * @return
     */
    ...
    /**
     * Handles menu item clicks. Detects if the 'Refresh' men item is clicked, and performs a
     * refresh on the data displayed.
     *
